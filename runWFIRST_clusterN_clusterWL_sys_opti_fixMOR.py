...
chain_file = "/extra/timeifler/WFIRST_forecasts/chains/like_WFIRST_clusterN_clusterWL_sys_opti_fixMOR"
#chain_file = "like/like_WFIRST_clusterN_clusterWL_sys_opti_fixMOR"
