...
chain_file = "like/like_WFIRST_SN"
initcosmo("halofit")
initbins(25,30.0,15000.0,4000.0,21.0,10,10)
initpriors("photo_opti","shear_opti","none","WFIRST_SN")
initsurvey("WFIRST")
...
sample_params=sample_cosmology_SN_WFIRST()

sample_main(sample_params,5000,200,1,chain_file, blind=False, pool=MPIPool())
