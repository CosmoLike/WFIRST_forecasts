...
cov_file = os.path.join(dirname, "cov/cov_3x2pt_cluster_4.500000e+01_2.000000e+03_WFIRST_2pt_clusterN_clusterWL_inv")
chain_file = os.path.join(dirname, "like/like_WFIRST_4.500000e+01_2.000000e+03_Rmin10_Ncl15_Ntomo10_no_sys_2pt_cluster")

initcosmo()
initbins(15,20.0,15000.0,5000.0,10.0,7,10)
initsurvey("WFIRST")
