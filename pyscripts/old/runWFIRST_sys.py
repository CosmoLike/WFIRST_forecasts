...
data_file = os.path.join(dirname, "datav/WFIRST_all_2pt_clusterN_clusterWL_fid_SN10")
cov_file = os.path.join(dirname, "cov/WFIRST_SNclustering10_3x2pt_clusterN_clusterWL_inv")
chain_file = os.path.join(dirname, "like/like_WFIRST_ocelote_SN10_sys")
