...
data_file = os.path.join(dirname, "datav/WFIRST_pos_pos_fid_SN10")
cov_file = os.path.join(dirname, "cov/WFIRST_SNclustering10_pos_pos_inv")
chain_file = os.path.join(dirname, "like/like_WFIRST_ocelote_pos_pos_SN10")
