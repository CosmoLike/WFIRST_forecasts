...
data_file = os.path.join(dirname, "datav_mg_musigma/WFIRST_shear_shear_fid")
cov_file = os.path.join(dirname, "cov/cov_Multi_Probe_WFIRST_4.500000e+01_2.200000e+03_Rmin10_Ncl20_Ntomo10_shear_inv")
chain_file = os.path.join(dirname, "./like/like_WFIRST_4.500000e+01_2.200000e+03_Rmin10_Ncl20_Ntomo10_no_sys_shear")
