...
file_source_z = os.path.join(dirname, "zdistris/redshifts_nonifc_0.2.txt")
file_lens_z = os.path.join(dirname, "zdistris/redshifts_nonifc_0.2.txt")
data_file = os.path.join(dirname, "datav/WFIRST_shear_shear_fid_nonifc_02")
cov_file = os.path.join(dirname, "cov/cov_WL_nonIFC_02cut_3.285000e+01_2.000000e+03_WFIRST_Ncl20_Ntomo10_shear_inv")
chain_file = os.path.join(dirname, "./like/like_WFIRST_nonifc_02cut_3.285000e+01_2.000000e+03_Rmin10_Ncl20_Ntomo10_no_sys")
